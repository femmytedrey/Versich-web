          ...
          <div className='w-full' >
            ...
            <form noValidate onSubmit={methods.handleSubmit(onSubmit)}>
              <div className='space-y-4 text-start md:space-y-5  '>
                <InputText label='Email address or username' name='combinedInputs' inputType='text' placeholder='Enter your email or username' rules={{required: 'Field is required'}} />
                <InputText
                ...
                <Link to='#' className='underline block text-sm hover:text-versich-blue-hover text-center' href='#'>Forget Password</Link>
                <p className='text-sm text-center'>Don't have an account? <Link to='/signup' className='text-versich-blue hover:text-versich-blue-hover hover:underline' href='#'>Sign up</Link></p>
