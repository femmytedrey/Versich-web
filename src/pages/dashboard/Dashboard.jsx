            ...
            <div className="flex flex-col xl:flex-row gap-x-6 gap-y-5">
                <div className="bg-white shadow-lg px-4 py-4 rounded-xl h-[325px] flex-1">
                    ...
                    <div className="flex flex-col items-center gap-y-3 py-4 bg-[#D9EBFC] my-4 rounded-lg">
                        ...
                        <div>
                            {progress < 100
                                ? <p>Complete your profile <Link to={setupPath} className="text-versich-blue underline">here</Link></p>
                                : <p>Your profile is completed</p>}
                        </div>
                    </div>
                    <div className="w-40">
                        <ConfirmButton type="submit" text="Edit profile" clickHandler={editBtn} />
                    </div>
                </div>
                ...
                <div className="bg-white shadow-lg px-4 py-4 rounded-xl space-y-4 text-start h-[435px] xl:h-[400px] flex-1">
                    <div>
                        <p className="text-start text-xl font-semibold text-versich-dark-blue">Lead setting</p>
                    </div>
                    <div>
                        <div>
                            <p className="text-versich-dark-blue font-medium mb-1">Services</p>
                            <p className="text-sm text-versich-label mb-1">You’ll receive leads in these categories</p>
                        </div>
                        <div className="flex flex-col sm:flex-row gap-3">
                            <button className="border-[1px] border-versich-border text-xs md:text-sm text-versich-border rounded-xl px-3 py-2 hover:bg-versich-blue hover:text-white">Mobile app</button>
                            <button className="border-[1px] border-versich-border text-xs md:text-sm text-versich-border rounded-xl px-3 py-2 hover:bg-versich-blue hover:text-white">Software development</button>
                        </div>
                    </div>
                    <div>
                        <div>
                        ...
                        <div>
                            <div className="flex flex-col gap-y-1">
                                ...
                                <p className="text-versich-blue underline underline-offset-2 cursor-pointer">info@user.com</p>
                            </div>
                            <div className="flex items-center gap-x-1 mb-3">
                                <CiLocationOn />
                                <p className="text-sm">Worldwide</p>
                        ...
                        <div className="w-40">
                            <ConfirmButton type="submit" text="Edit setting" />
                        </div>
                    </div>
                </div>
                ...
                <div className="space-y-4 flex-1">
                    <div className="bg-white shadow-lg px-4 py-4 rounded-xl space-y-4 text-start">
                        <div>
                            <p className="text-start text-xl font-semibold text-versich-dark-blue">Leads</p>
                        </div>
                        ...
                        <div className="w-40">
                            <ConfirmButton type="submit" text="View leads" />
                        </div>
                    </div>
                    <div className="bg-white shadow-lg px-4 py-4 rounded-xl space-y-4 text-start">
                        <div>
                            <p className="text-start text-xl font-semibold text-versich-dark-blue">Responses</p>
                        </div>
                        <div className="flex items-center gap-x-3">
                            <div className="bg-[#D9EBFC] rounded-full p-3 text-versich-dark-blue">
                                <GoRead />
                    ...
                    <div className="bg-white shadow-lg px-4 py-4 rounded-xl space-y-4 text-start">
                        <div>
                            <p className="text-start text-xl font-semibold text-versich-dark-blue">Help</p>
                        </div>
                        <div className="flex items-center gap-x-3">
                            <div className="bg-[#D9EBFC] rounded-full p-3 text-versich-dark-blue">
                                <GoRead />
                            </div>
                            <div className="text-sm">Email <span className="text-versich-blue underline underline-offset-2">info@versich.com</span></div>
                        </div>
                        <div className="flex items-center gap-x-3">
                            <div className="bg-[#D9EBFC] rounded-full p-3 text-versich-dark-blue">
                                <GoUnread />
                            </div>
                            <div className="text-sm">Call <span className="text-versich-blue underline underline-offset-2">112 2354 8898</span> open 24 hours a day, 7 days a week</div>
                        </div>
                    </div>
                </div>
            </div>
