...
const FinanceBudget = ({ register, errors, setValue, formData, setFormData }) => {
  ...
  useEffect(() => {
    ...
    Object.keys(updatedBudgets).forEach((key) => {
      updatedBudgets[key].selected =
        updatedBudgets[key].value === formData.budgetOption;
    });
    if (budgets.other.value !== "" && budgets.other.selected) {
      setShowOtherInput(true);
    }
  }, [formData.budgetOption, budgetOtherInputValue]);
  ...
  const handleBudgetSelect = (optionKey) => {
    ...
    setValue("budgetOption", selectedValue);
    setFormData({ ...formData, budgetOption: selectedValue });
  ...
  const handleInputChange = (event) => {
    ...
    setValue("budgetOption", value);
    setFormData({ ...formData, budgetOption: value });
    ...
    <div>
      <div className="space-y-4 pb-12">
        ...
        <div className="relative space-y-3">
            ...
            {Object.keys(budgets).map((key) => {
              ...
              return (
                ...
                >
                  ...
                  <label htmlFor="budgetOption" className="text-sm ps-2">
                    {budget.label}
                  </label>
                </div>
              );
          ...
          {errors.budgetOption?.type === "otherInput" && (
            <div className="pb-3">
          ...
          {!isBudgetSelected && errors.budgetOption && (
            <div className="pb-3">
