...
const OtherFinanceProjectCommencement = ({
  register,
  errors,
  setValue,
  formData,
  ...
  const handleOptionSelect = (optionKey) => {
    ...
    setValue("OtherProjectCommencement", selectedValue);
    setFormData({ ...formData, OtherProjectCommencement: selectedValue });
  ...
  return (
    <div>
      <div className="space-y-4 pb-12">
          ...
          {Object.keys(projectCommencements).map((key) => {
            ...
            return (
              ...
              >
                <input
                  type="radio"
                  name="OtherProjectCommencement"
                  value={projectCommencement.value}
                  className="appearance-none"
                  {...register("OtherProjectCommencement", {
                    required: true,
                    validate: {
                      otherInput: () => {
                        if (
        ...
        {errors.OtherProjectCommencement?.type === "otherInput" && (
          <p className="text-red-500 text-sm">Please enter a value for Other</p>
        )}

        {!isprojectCommencementSelected && errors.OtherProjectCommencement && (
          <div className="pb-3">
...
export default OtherFinanceProjectCommencement;
