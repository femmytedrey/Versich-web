...
const DigitalTransformFinanceNeededTools = ({
  register,
  errors,
  setValue,
  formData,
  ...
  useEffect(() => {
    if (formData.DigitalTransformFinanceTools) {
      const updatedOptions = { ...financeServiceNeed };
      formData.DigitalTransformFinanceTools.forEach((selected) => {
  ...
  }, [formData.DigitalTransformFinanceTools]);
  ...
  return (
    <div>
      <div className="space-y-4 pb-12">
        ...
        {!isAnySelected && errors.DigitalTransformFinanceTools && (
          <div className="pb-3">
...
export default DigitalTransformFinanceNeededTools;
