...
const DigitalTransformFinanceProjectCommencement = ({
  register,
  errors,
  setValue,
  formData,
  ...
  return (
    <div>
      <div className="space-y-4 pb-12">
          ...
          {Object.keys(projectCommencements).map((key) => {
            ...
            return (
              ...
              >
                <input
                  type="radio"
                  name="DigitalTransformProjectCommencement"
                  value={projectCommencement.value}
                  className="appearance-none"
                  {...register("DigitalTransformProjectCommencement", {
                    required: true,
                    validate: {
                      otherInput: () => {
                        if (
        ...
        {errors.DigitalTransformProjectCommencement?.type === "otherInput" && (
...
export default DigitalTransformFinanceProjectCommencement;
