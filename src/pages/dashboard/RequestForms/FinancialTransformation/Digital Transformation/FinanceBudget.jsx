...
const DigitalTransformationFinanceBudget = ({ register, errors, setValue, formData, setFormData }) => {
            ...
            {Object.keys(budgets).map((key) => {
              ...
              return (
                ...
                >
                  ...
                  <label htmlFor="DigitalTransformBudgetOption" className="text-sm ps-2">
                    {budget.label}
                  </label>
                </div>
              );
