...
const SystemAdministratinoFinanceProjectCommencement = ({
  register,
  errors,
  setValue,
  formData,
          ...
          {Object.keys(projectCommencements).map((key) => {
            ...
            return (
              ...
              >
                <input
                  type="radio"
                  name="SystemAdminFinanceProjectCommencement"
                  value={projectCommencement.value}
                  className="appearance-none"
                  {...register("SystemAdminFinanceProjectCommencement", {
                    required: true,
                    validate: {
                      otherInput: () => {
                        if (
...
export default SystemAdministratinoFinanceProjectCommencement;
