      ...
      <div className='py-10 md:py-14 px-3 mb-12 overflow-hidden bg-versich-primary-bg flex items center justify-center'>
        <div className='w-full bg-white shadow-md py-5 md:py-10 px-3 md:px-10 max-w-[580px] rounded-md space-y-6'>
          ...
          <div className='grid grid-cols-1 gap-5 md:grid-cols-2'>
            <DropdownField options={milesCoverage} placeholder='<-- Select -->' name='milesCoverage' rules={{ required: 'Please select an option' }} />
            <DropdownField options={postcodes} placeholder='<-- Select -->' name='postcodes' rules={{ required: 'Please select an option' }} />
          </div>
