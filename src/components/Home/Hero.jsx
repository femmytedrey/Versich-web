...
const Hero = () => {
  return (
    ...
    className="background-image bg-cover bg-center bg-no-repeat mt-[-115px] h-hero-height">
      <div className='text-start text-white px-8 md:px-20 lg:px-28 w-full h-full bg-black bg-opacity-80 pt-[200px] '>
